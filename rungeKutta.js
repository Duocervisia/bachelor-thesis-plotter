class Beyer {
  ...
  calcPvDcBeyer( G, T_a, dt,pv_mod, T_vor, T_Vor_Anpassen){
    ...
    tempRungeKutta(T_a, G, dt, T_vor) {
        ...
        let k1 = this.tempIncrementFormula(T_a, G, dt, T_vor);
        let k2 = this.tempIncrementFormula(T_a, G, dt, T_vor + 0.5*k1);
        let k3 = this.tempIncrementFormula(T_a, G, dt, T_vor + 0.5*k2);
